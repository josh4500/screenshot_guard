...
void main() {
  ...
  group('ScreenshotShieldGuard', () {
    testWidgets(
      'activates protection and listening while active',
      (tester) async {
    ...
    testWidgets(
      'releases protection and listening when deactivated',
      (tester) async {
        await tester.pumpWidget(_GuardHarness(shield: shield));
        await tester.pump();
    ...
    testWidgets(
      're-activates protection and listening when activated again',
      (tester) async {
        await tester.pumpWidget(_GuardHarness(shield: shield));
        await tester.pump();
    ...
    testWidgets(
      'invokes onScreenshotDetected while active',
      (tester) async {
        var screenshots = 0;
    ...
    testWidgets(
      'does not invoke onScreenshotDetected while inactive',
      (tester) async {
        var screenshots = 0;
        await tester.pumpWidget(
          _GuardHarness(shield: shield, onScreenshotDetected: (_) => screenshots++, captureOnScreenshot: false),
    ...
    testWidgets(
      'releases protection and listening when disposed',
      (tester) async {
        await tester.pumpWidget(_GuardHarness(shield: shield));
        await tester.pump();
